...
$(function() {
	$("#nextBtn").click(function(){
		...
		var chkOutpotArr = new Array();
		//확인된 체크박스만 가져와서 반복(최소화된 반복을 수행)
		$("[name='seatNumIn']:checked").each(function(i, element){
			chkValArr.push($(element).val());
			chkOutpotArr.push($(element).val()+" ");
		});//each
		
		//체크된 값이 없을 때에는 "선택하신 언어가 없습니다."를 출력.
		if($("[name='seatNumIn']:checked").length==0){
			alert("선택하신 좌석이 없습니다.");
		}//end if
		
		$("#seatNumOutput").html(chkOutpotArray);
		
	});//click
});//ready

function alreadyChk(seatNumIn){
	var seatNumArr=seatNumIn;
	$("[name='seatNumIn']").each(function(i, element){
		for(var i=0;i<seatNumArr.length;i++){
			if(seatNumArr[i]==$(element).val()){
				$("input[name='seatNumIn']").attr("checked", true);
			}//end if
		}//end for
	});//each
		...
		<div class="container">
			<div class="site-navigation">
				...
				<ul
					...
					<li><a href="user_reservation_course.html">투어예약</a></li>
		...
		<form>
				...
				<div style="display: flex; width: 85%; align-items: center; justify-content: space-around; background-color: #fafafa; border-left: 2px solid #ddd; border-right: 2px solid #ddd;">
					...
					<div style="width: 90%; height: 100%;">
						<table style="width: 100%; height: 100%;">
							<tr>
								<td><input type="checkbox" name="seatNumIn" value="3"></td>
								<td>03</td>
								<td><input type="checkbox" name="seatNumIn" value="6"></td>
								<td>06</td>
								<td><input type="checkbox" name="seatNumIn" value="9"></td>
								<td>09</td>
								<td><input type="checkbox" name="seatNumIn" value="12"></td>
								<td>12</td>
								<td><input type="checkbox" name="seatNumIn" value="15"></td>
								<td>15</td>
								<td><input type="checkbox" name="seatNumIn" value="18"></td>
								<td>18</td>
								<td><input type="checkbox" name="seatNumIn" value="21"></td>
								<td>21</td>
								<td><input type="checkbox" name="seatNumIn" value="24"></td>
								<td>24</td>
								<td><input type="checkbox" name="seatNumIn" value="28"></td>
								<td>28</td>
							</tr>
							<tr>
								<td colspan="16"></td>
								<td><input type="checkbox" name="seatNumIn" value="26"></td>
								<td>26</td>
							</tr>
							<tr>
								<td><input type="checkbox" name="seatNumIn" value="2"></td>
								<td>02</td>
								<td><input type="checkbox" name="seatNumIn" value="5"></td>
								<td>05</td>
								<td><input type="checkbox" name="seatNumIn" value="8"></td>
								<td>08</td>
								<td><input type="checkbox" name="seatNumIn" value="11"></td>
								<td>11</td>
								<td><input type="checkbox" name="seatNumIn" value="14"></td>
								<td>14</td>
								<td><input type="checkbox" name="seatNumIn" value="17"></td>
								<td>17</td>
								<td><input type="checkbox" name="seatNumIn" value="20"></td>
								<td>20</td>
								<td><input type="checkbox" name="seatNumIn" value="23"></td>
								<td>23</td>
								<td><input type="checkbox" name="seatNumIn" value="26"></td>
								<td>26</td>
							</tr>
							<tr>
								<td><input type="checkbox" name="seatNumIn" value="1"></td>
								<td>01</td>
								<td><input type="checkbox" name="seatNumIn" value="4"></td>
								<td>04</td>
								<td><input type="checkbox" name="seatNumIn" value="7"></td>
								<td>07</td>
								<td><input type="checkbox" name="seatNumIn" value="10"></td>
								<td>10</td>
								<td><input type="checkbox" name="seatNumIn" value="13"></td>
								<td>13</td>
								<td><input type="checkbox" name="seatNumIn" value="16"></td>
								<td>16</td>
								<td><input type="checkbox" name="seatNumIn" value="19"></td>
								<td>19</td>
								<td><input type="checkbox" name="seatNumIn" value="22"></td>
								<td>22</td>
								<td><input type="checkbox" name="seatNumIn" value="25"></td>
								<td>25</td>
							</tr>
						</table>
					</div>
			...
			<div style="margin-bottom: 100px;">
				<table class="member" style="width: 100%;">
					...
					<tr>
						<th>예약한 좌석 번호</th>
						<td><div id="seatNumOutput"></div></td>
					</tr>
				</table>
			</div>
			...
			<div style="display: flex; justify-content: end; margin-bottom: 100px;">
				<!-- <input type="button" id="nextBtn" class="mainBtn" value="다음" style="width: 80px; height: 32px;" onclick="location.href='http://localhost/goyang_myprj/User/user_reservation_confirm.html'"> -->
