...
$(function(){
	...
	$('#btn-add-row').click(function() {
		...
		var tableTemp ="<tr><td><input type='text' name='tourOrderIn' value='" + tableCnt++ + "' readonly='readonly'/></td>"
...
%>
  ...
  <table class="member tableSize" id="tableAction">
  	...
  	%>
  	<tr>
  		<td><input type="text" name="tourOrderIn" value="<%= tourSportList.get(i).getTourOrder() %>" readonly="readonly"/></td>
