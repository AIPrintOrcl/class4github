...
public class TourReservaVO {
	...
	public TourReservaVO(int tourNum, int adultFee, int otherFee, int tourOrder, int adultCnt, int otherCnt,
			int reserNum, int totalSeatCnt, int runFlag, int[] seatNum, String id, String name, String tourName,
	...
	public String toString() {
		return "TourReservaVO [tourNum=" + tourNum + ", adultFee=" + adultFee + ", otherFee=" + otherFee
				...
				+ Arrays.toString(seatNum) + ", id=" + id + ", name=" + name + ", tourName=" + tourName + ", explain="
				+ explain + ", thumImg=" + thumImg + ", cosContent=" + cosContent + ", startHour=" + startHour
				+ ", endHour=" + endHour + ", reserDate=" + reserDate + ", reserRegist=" + reserRegist + "]";
	}//toString
