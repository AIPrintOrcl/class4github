...
public class TourReservaVO {
	...
	private int[] seatNum;
	private String id, name, tourName, explain, thumImg, cosContent, startHour, endHour;
	private Date reserDate, reserRegist;
	...
	public TourReservaVO(int tourNum, int adultFee, int otherFee, int tourOrder, int adultCnt, int otherCnt,
			int reserNum, int totalSeatCnt, int[] seatNum, String id, String name, String tourName, String explain,
			String thumImg, String cosContent, String startHour, String endHour, Date reserDate, Date reserRegist) {
		super();
	...
	public String toString() {
		return "TourReservaVO [tourNum=" + tourNum + ", adultFee=" + adultFee + ", otherFee=" + otherFee
				...
				+ reserNum + ", totalSeatCnt=" + totalSeatCnt + ", seatNum=" + Arrays.toString(seatNum) + ", id=" + id
				+ ", name=" + name + ", tourName=" + tourName + ", explain=" + explain + ", thumImg=" + thumImg
				+ ", cosContent=" + cosContent + ", startHour=" + startHour + ", endHour=" + endHour + ", reserDate="
				+ reserDate + ", reserRegist=" + reserRegist + "]";
	}//toString
